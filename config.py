...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/kanish-ai/NOBITA_MUSIC",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/POETRY_BY_TOXIC")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/TOXIC_X_SOCIETY")
